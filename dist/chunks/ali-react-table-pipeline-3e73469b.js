...
function HtmlTable({ tbodyHtmlTag, getRowProps, primaryKey, data, verticalRenderInfo: verInfo, horizontalRenderInfo: hozInfo, components: { Row, Cell, TableBody }, }) {
    ...
    const leftFlatCount = flat.left.length;
    const rightFlatCount = flat.right.length;
    const tbody = TableBody != null && tbodyHtmlTag === 'tbody' ? (React__default["default"].createElement(TableBody, { tbodyProps: { children: data.map(renderRow) } })) : (React__default["default"].createElement(tbodyHtmlTag, null, data.map(renderRow)));
    return (React__default["default"].createElement("table", null,
        React__default["default"].createElement(Colgroup, { descriptors: hozInfo.visible }),
        tbody));
    function renderRow(row, i) {
        const rowIndex = verInfo.offset + i;
        spanManager.stripUpwards(rowIndex);
        const rowProps = getRowProps(row, rowIndex);
        const rowClass = cx__default["default"](Classes.tableRow, {
        ...
        const trProps = Object.assign(Object.assign({}, rowProps), { className: rowClass, 'data-rowindex': rowIndex, children: hozInfo.visible.map((descriptor) => {
                if (descriptor.type === 'blank') {
                    return React__default["default"].createElement("td", { key: descriptor.blankSide });
                }
        ...
        if (Row != null && tbodyHtmlTag === 'tbody') {
            return React__default["default"].createElement(Row, { key, row, rowIndex, trProps });
        }
        else {
            return React__default["default"].createElement("tr", Object.assign({ key: key }, trProps));
        }
    }
    function renderBodyCell(row, rowIndex, column, colIndex) {
        ...
        const tdProps = Object.assign(Object.assign(Object.assign(Object.assign({}, cellProps), { className: cx__default["default"](Classes.tableCell, cellProps.className, {
                first: colIndex === 0,
                last: colIndex + colSpan === fullFlatCount,
                'lock-left': colIndex < leftFlatCount,
                'lock-right': colIndex >= fullFlatCount - rightFlatCount,
        ...
        if (Cell != null && tbodyHtmlTag === 'tbody') {
            return React__default["default"].createElement(Cell, { key: colIndex, tdProps: tdProps, row: row, rowIndex: rowIndex, column: column, colIndex: colIndex });
        }
        else {
            return React__default["default"].createElement("td", Object.assign({ key: colIndex }, tdProps));
        }
    }
}

const DefaultLoadingIcon = React__default["default"].memo(() => (React__default["default"].createElement("svg", { style: { margin: 'auto', display: 'block', width: 40, height: 40 }, viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid" },
    React__default["default"].createElement("circle", { cx: "50", cy: "50", r: "40", fill: "none", stroke: "#23a7fa", strokeDasharray: "188 64", strokeLinecap: "round", strokeWidth: "10" },
        React__default["default"].createElement("animateTransform", { attributeName: "transform", dur: "1.5s", keyTimes: "0;1", repeatCount: "indefinite", type: "rotate", values: "0 50 50;360 50 50" })))));
function DefaultLoadingContentWrapper({ children, visible }) {
    return (React__default["default"].createElement("div", { className: "art-loading-content-wrapper", style: { filter: visible ? 'blur(1px)' : 'none' } }, children));
}
function Loading({ visible, children, LoadingContentWrapper = DefaultLoadingContentWrapper, LoadingIcon = DefaultLoadingIcon, }) {
    return (React__default["default"].createElement("div", { className: Classes.loadingWrapper },
        visible && (React__default["default"].createElement("div", { className: Classes.loadingIndicatorWrapper },
            React__default["default"].createElement("div", { className: Classes.loadingIndicator },
                React__default["default"].createElement(LoadingIcon, null)))),
        React__default["default"].createElement(LoadingContentWrapper, { visible: visible, children: children })));
}
...
class BaseTable extends React__default["default"].Component {
    constructor(props) {
        super(props);
        this.rowHeightManager = makeRowHeightManager(this.props.dataSource.length, this.props.estimatedRowHeight);
        this.artTableWrapperRef = React__default["default"].createRef();
    ...
    renderTableHeader(info) {
        ...
        return (React__default["default"].createElement("div", { className: cx__default["default"](Classes.tableHeader, 'no-scrollbar'), style: {
                top: stickyTop === 0 ? undefined : stickyTop,
                display: hasHeader ? undefined : 'none',
            } },
            React__default["default"].createElement(TableHeader, { info: info })));
    }
    ...
    renderTableBody(info) {
        ...
        const tableBodyClassName = cx__default["default"](Classes.tableBody, Classes.horizontalScrollContainer, {
        ...
        if (dataSource.length === 0) {
            ...
            return (React__default["default"].createElement("div", { className: tableBodyClassName },
                React__default["default"].createElement(EmptyHtmlTable, { descriptors: info.visible, isLoading: isLoading, EmptyContent: EmptyContent, emptyCellHeight: emptyCellHeight })));
        }
        const { topIndex, bottomBlank, topBlank, bottomIndex } = info.verticalRenderRange;
        return (React__default["default"].createElement("div", { className: tableBodyClassName },
            topBlank > 0 && (React__default["default"].createElement("div", { key: "top-blank", className: cx__default["default"](Classes.virtualBlank, 'top'), style: { height: topBlank } })),
            React__default["default"].createElement(HtmlTable, { components: components, tbodyHtmlTag: "tbody", getRowProps: getRowProps, primaryKey: primaryKey, data: dataSource.slice(topIndex, bottomIndex), horizontalRenderInfo: info, verticalRenderInfo: {
                    first: 0,
                    offset: topIndex,
                    limit: bottomIndex,
                    last: dataSource.length - 1,
                } }),
            bottomBlank > 0 && (React__default["default"].createElement("div", { key: "bottom-blank", className: cx__default["default"](Classes.virtualBlank, 'bottom'), style: { height: bottomBlank } }))));
    }
    renderTableFooter(info) {
        const { footerDataSource = [], getRowProps, primaryKey, stickyBottom, components } = this.props;
        return (React__default["default"].createElement("div", { className: cx__default["default"](Classes.tableFooter, Classes.horizontalScrollContainer), style: { bottom: stickyBottom === 0 ? undefined : stickyBottom } },
            React__default["default"].createElement(HtmlTable, { components: components, tbodyHtmlTag: "tfoot", data: footerDataSource, horizontalRenderInfo: info, getRowProps: getRowProps, primaryKey: primaryKey, verticalRenderInfo: {
                    offset: 0,
                    first: 0,
    ...
    renderLockShadows(info) {
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement("div", { className: Classes.lockShadowMask, style: { left: 0, width: info.leftLockTotalWidth + LOCK_SHADOW_PADDING } },
                React__default["default"].createElement("div", { className: cx__default["default"](Classes.lockShadow, Classes.leftLockShadow) })),
            React__default["default"].createElement("div", { className: Classes.lockShadowMask, style: { right: 0, width: info.rightLockTotalWidth + LOCK_SHADOW_PADDING } },
                React__default["default"].createElement("div", { className: cx__default["default"](Classes.lockShadow, Classes.rightLockShadow) }))));
    }
    renderStickyScroll(info) {
        const { hasStickyScroll, stickyBottom } = this.props;
        const { hasScroll } = this.state;
        return (React__default["default"].createElement("div", { className: cx__default["default"](Classes.stickyScroll, Classes.horizontalScrollContainer), style: {
                display: hasStickyScroll && hasScroll ? 'block' : 'none',
                bottom: stickyBottom,
            } },
            React__default["default"].createElement("div", { className: Classes.stickyScrollItem })));
    }
    render() {
        ...
        const artTableWrapperClassName = cx__default["default"](Classes.artTableWrapper, {
        ...
        return (React__default["default"].createElement(StyledArtTableWrapper, Object.assign({}, artTableWrapperProps),
            React__default["default"].createElement(Loading, { visible: isLoading, LoadingIcon: components.LoadingIcon, LoadingContentWrapper: components.LoadingContentWrapper },
                React__default["default"].createElement("div", { className: Classes.artTable },
    ...
    componentDidMount() {
        ...
        this.props$ = new rxjs.BehaviorSubject(this.props);
    ...
    initSubscriptions() {
        ...
        const richVisibleRects$ = getRichVisibleRectsStream(this.domHelper.artTable, this.props$.pipe(op__namespace.skip(1), op__namespace.mapTo('structure-may-change')), this.props.virtualDebugLabel).pipe(op__namespace.shareReplay());
        // 每当可见部分发生变化的时候，调整 loading icon 的未知（如果 loading icon 存在的话）
        this.rootSubscription.add(rxjs.combineLatest([
            richVisibleRects$.pipe(op__namespace.map((p) => p.clipRect), op__namespace.distinctUntilChanged(shallowEqual)),
            this.props$.pipe(op__namespace.startWith(null), op__namespace.pairwise(), op__namespace.filter(([prevProps, props]) => prevProps == null || (!prevProps.isLoading && props.isLoading))),
        ]).subscribe(([clipRect]) => {
        ...
        this.rootSubscription.add(richVisibleRects$
            .pipe(op__namespace.filter(() => {
            const { horizontal, vertical } = this.lastInfo.useVirtual;
            return horizontal || vertical;
        }), op__namespace.map(({ clipRect, offsetY }) => ({
            maxRenderHeight: clipRect.bottom - clipRect.top,
            maxRenderWidth: clipRect.right - clipRect.left,
            offsetY,
        })), op__namespace.distinctUntilChanged((x, y) => {
...
const InlineFlexCell = styled__default["default"].div `
  display: inline-flex;
  align-items: center;
`;
const ExpansionCell = styled__default["default"](InlineFlexCell) `
  &.leaf {
    cursor: default;
  }
  .action-icon {
...
function CaretDownIcon(props) {
    return (React__default["default"].createElement("svg", Object.assign({ focusable: "false", preserveAspectRatio: "xMidYMid meet", fill: "currentColor", width: "16", height: "16", viewBox: "0 0 32 32" }, props),
        React__default["default"].createElement("path", { d: "M24 12L16 22 8 12z" })));
}
function InfoIcon(props) {
    return (React__default["default"].createElement("svg", Object.assign({ focusable: "false", preserveAspectRatio: "xMidYMid meet", fill: "currentColor", width: "16", height: "16", viewBox: "0 0 16 16" }, props),
        React__default["default"].createElement("path", { d: "M8.5 11L8.5 6.5 6.5 6.5 6.5 7.5 7.5 7.5 7.5 11 6 11 6 12 10 12 10 11zM8 3.5c-.4 0-.8.3-.8.8S7.6 5 8 5c.4 0 .8-.3.8-.8S8.4 3.5 8 3.5z" }),
        React__default["default"].createElement("path", { d: "M8,15c-3.9,0-7-3.1-7-7s3.1-7,7-7s7,3.1,7,7S11.9,15,8,15z M8,2C4.7,2,2,4.7,2,8s2.7,6,6,6s6-2.7,6-6S11.3,2,8,2z" })));
}
function CaretRightIcon(props) {
    return (React__default["default"].createElement("svg", Object.assign({ focusable: "false", preserveAspectRatio: "xMidYMid meet", fill: "currentColor", width: "16", height: "16", viewBox: "0 0 32 32" }, props),
        React__default["default"].createElement("path", { d: "M12 8L22 16 12 24z" })));
}
function CaretPlusIcon(props) {
    return (React__default["default"].createElement("svg", Object.assign({ focusable: "false", preserveAspectRatio: "xMidYMid meet", viewBox: "0 0 1024 1024", fill: "currentColor", width: "16", height: "16" }, props),
        React__default["default"].createElement("path", { d: "M328 544h152v152c0 4.4 3.6 8 8 8h48c4.4 0 8-3.6 8-8V544h152c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H544V328c0-4.4-3.6-8-8-8h-48c-4.4 0-8 3.6-8 8v152H328c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8z" }),
        React__default["default"].createElement("path", { d: "M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32z m-40 728H184V184h656v656z" })));
}
function CaretMinusIcon(props) {
    return (React__default["default"].createElement("svg", Object.assign({ focusable: "false", preserveAspectRatio: "xMidYMid meet", viewBox: "0 0 1024 1024", fill: "currentColor", width: "16", height: "16" }, props),
        React__default["default"].createElement("path", { d: "M328 544h368c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8H328c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8z" }),
        React__default["default"].createElement("path", { d: "M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32z m-40 728H184V184h656v656z" })));
}
function LoadingIcon(props) {
    return (React__default["default"].createElement("svg", Object.assign({ width: "16", height: "16", fill: "currentColor", viewBox: "0 0 1024 1024" }, props),
        React__default["default"].createElement("path", { d: "M512 74.667c-17.067 0-32 14.933-32 32V256c0 17.067 14.933 32 32 32s32-14.933 32-32V106.667c0-17.067-14.933-32-32-32zm181.333 288c8.534 0 17.067-2.134 23.467-8.534L821.333 249.6c12.8-12.8 12.8-32 0-44.8-12.8-12.8-32-12.8-44.8 0L672 309.333c-12.8 12.8-12.8 32 0 44.8 4.267 6.4 12.8 8.534 21.333 8.534zm224 117.333H768c-17.067 0-32 14.933-32 32s14.933 32 32 32h149.333c17.067 0 32-14.933 32-32s-14.933-32-32-32zM714.667 669.867c-12.8-12.8-32-12.8-44.8 0s-12.8 32 0 44.8L774.4 819.2c6.4 6.4 14.933 8.533 23.467 8.533s17.066-2.133 23.466-8.533c12.8-12.8 12.8-32 0-44.8L714.667 669.867zM512 736c-17.067 0-32 14.933-32 32v149.333c0 17.067 14.933 32 32 32s32-14.933 32-32V768c0-17.067-14.933-32-32-32zm-202.667-66.133L204.8 774.4c-12.8 12.8-12.8 32 0 44.8 6.4 6.4 14.933 8.533 23.467 8.533s17.066-2.133 23.466-8.533l104.534-104.533c12.8-12.8 12.8-32 0-44.8s-36.267-12.8-46.934 0zM288 512c0-17.067-14.933-32-32-32H106.667c-17.067 0-32 14.933-32 32s14.933 32 32 32H256c17.067 0 32-14.933 32-32zm-40.533-309.333c-12.8-12.8-32-12.8-44.8 0-12.8 12.8-12.8 32 0 44.8L307.2 352c6.4 6.4 14.933 8.533 23.467 8.533s17.066-2.133 23.466-8.533c12.8-12.8 12.8-32 0-44.8L247.467 202.667z" })));
}
const icons = {
    Loading: LoadingIcon,
    CaretDown: CaretDownIcon,
    CaretRight: CaretRightIcon,
    CaretPlus: CaretPlusIcon,
    CaretMinus: CaretMinusIcon,
    Info: InfoIcon,
};
    ...
    return function treeModeStep(pipeline) {
        ...
        function processColumns(columns) {
            ...
            const render = (value, record, recordIndex) => {
                ...
                if (isLeaf) {
                    return (React__default["default"].createElement(InlineFlexCell, { className: "expansion-cell leaf" },
                        React__default["default"].createElement("span", { style: { marginLeft: indent + iconWidth + iconGap } }, content)));
                }
                const onClick = (e) => {
                ...
                const ActionIcon = expanded ? icons.CaretMinus : icons.CaretPlus;
                return (React__default["default"].createElement(ExpansionCell, { className: cx__default["default"]('expansion-cell', expandCls), style: {
                        cursor: clickArea === 'content' ? 'pointer' : undefined,
                    }, onClick: clickArea === 'content' ? onClick : undefined },
                    React__default["default"].createElement(ActionIcon, { className: cx__default["default"]('action-icon'), style: {
            ...
            return [
                Object.assign(Object.assign({}, firstCol), { title: (React__default["default"].createElement("span", { style: { marginLeft: iconIndent + iconWidth + iconGap } }, internals.safeRenderHeader(firstCol))), render, getCellProps: clickArea === 'cell' ? getCellProps : firstCol.getCellProps }),
                ...others,
            ];
        }
    };
...
exports.mergeCellProps = mergeCellProps;
